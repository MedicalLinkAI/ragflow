...
class TenantLLMService(CommonService):
    ...
    def get_my_llms(cls, tenant_id):
        fields = [cls.model.id, cls.model.llm_factory, LLMFactories.logo, LLMFactories.tags, cls.model.model_type,
                  cls.model.llm_name, cls.model.used_tokens, cls.model.status]
