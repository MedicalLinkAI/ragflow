...
- 处理耗时(服务端)：813.6407s  脚本耗时：869.2s
- 备注：progress_msg 未找到 SmartSplitter 类型日志。 
- 重解析前快照（无基线结果）：chunk_count=30 run=DONE clinical 类型记录数={'ExaminationReport': 13, 'LabReport': 11, 'AdmissionRecord': 1, 'DischargeRecord': 1, 'OutpatientRecord': 3}
