...
- 处理耗时(服务端)：231.6044s  脚本耗时：233.2s
- 重解析前快照（无基线结果）：chunk_count=1 run=DONE clinical 类型记录数={'OutpatientRecord': 1}

## 1. 页面覆盖率

| # | chunk_id(前8位) | 页数 | 页码范围 | 内容摘要 |
|---|----------------|------|----------|----------|
| 1 | b9efeab2 | 3 | 1-3 | 0179405 科室: 呼吸与危重症医学科门诊 病历 x GCP门诊病历 民医院 |
