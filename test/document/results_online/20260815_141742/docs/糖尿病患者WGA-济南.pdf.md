...
- 处理耗时(服务端)：97.05838s  脚本耗时：99.1s
- 重解析前快照（无基线结果）：chunk_count=6 run=DONE clinical 类型记录数={'LabReport': 2, 'OutpatientRecord': 2, 'MedicationRecord': 2}
...
| 3 | f53a0545 | 1 | 4-4 | 蘅薇园社区卫生服务站病历信息 门诊编号：2409160009 姓名： 性别：男  |
