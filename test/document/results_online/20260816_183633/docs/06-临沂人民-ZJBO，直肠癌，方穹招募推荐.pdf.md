...
- 处理耗时(服务端)：422.55524s  脚本耗时：442.8s
- 重解析前快照（无基线结果）：chunk_count=11 run=DONE clinical 类型记录数={'ExaminationReport': 6, 'AdmissionRecord': 1, 'DischargeRecord': 1, 'OutpatientRecord': 1, 'LabReport': 2}

## 1. 页面覆盖率

| # | chunk_id(前8位) | 页数 | 页码范围 | 内容摘要 |
|---|----------------|------|----------|----------|
| 1 | 954a8011 | 4 | 1-4 | 20200113根治术 术后XELOX 6周期 20240510复发 20240 |
| 2 | 60764c5e | 1 | 5-5 | 性别：男 年龄：64岁 出院日期：2026-01-07 17:10 住院天数：1 |
| 3 | f0f475dc | 1 | 8-8 | 【检查描述】：心搏次数：97(60~100)bpm，PR间隔：144ms，QRS |
...
| 9 | b437058f | 1 | 6-6 | <table><tr><td>KRAS Exon-2 (G12S,G12D)</ |
