...
- 处理耗时(服务端)：410.91196s  脚本耗时：414.4s
- 重解析前快照（无基线结果）：chunk_count=13 run=DONE clinical 类型记录数={'AdmissionRecord': 1, 'LabReport': 8, 'ExaminationReport': 2, 'DischargeRecord': 1}

## 1. 页面覆盖率

| # | chunk_id(前8位) | 页数 | 页码范围 | 内容摘要 |
|---|----------------|------|----------|----------|
| 1 | 793e2a82 | 1 | 1-1 | 华北理工大学附属医院 病理检查报告单 病理号: 姓名: 性别: 男 年龄: 申请 |
| 2 | eba12a68 | 5 | 2-6 | 华北理工大学附属医院 NORTH CHINA UNIVERSITY OF SCI |
| 3 | 18bd040d | 3 | 6-8 | 第4页 华北理工大学附属医院 NORTH CHINA UNIVERSITY OF |
...
| 7 | a1b724bc | 1 | 12-12 | <table><tr><td>总蛋白</td><td>TP</td><td>76 |
| 8 | 414f3c64 | 1 | 15-15 | <table><tr><td>乙型肝炎病毒表面抗原</td><td>HBsAg< |
| 9 | fa24235f | 1 | 12-12 | <table><tr><td>总胆固醇</td><td>CHOL</td><td |
