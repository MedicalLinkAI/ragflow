...
- 处理耗时(服务端)：439.29102s  脚本耗时：444.0s
- 重解析前快照（无基线结果）：chunk_count=8 run=DONE clinical 类型记录数={'LabReport': 3, 'ExaminationReport': 3, 'DischargeRecord': 1}
...
| 3 | db732d17 | 1 | 4-4 | 性别： ID号： 内镜编 塘电 临床诊断：位性病变（右肿门） 吸烟史：有 CT表 |
| 4 | 22ae33b9 | 2 | 8-9 | 入院时间：2026-03-12 14:28 出院时间：2026-03-14 09 |
