...
- 处理耗时(服务端)：230.159s  脚本耗时：234.6s
- 重解析前快照（无基线结果）：chunk_count=6 run=DONE clinical 类型记录数={'AdmissionRecord': 1, 'ExaminationReport': 1, 'LabReport': 4}

## 1. 页面覆盖率

| # | chunk_id(前8位) | 页数 | 页码范围 | 内容摘要 |
|---|----------------|------|----------|----------|
| 1 | b9e18ddb | 3 | 1-3 | PASS (省集1)注射用七... 科室:肿瘤科、血液科病历号: 费别:职工 成 |
| 2 | f8d2bebd | 2 | 8-9 | PASS (省集1)注射用七... 科室:肿瘤科、血液科病历号: 费别:职工 定 |
