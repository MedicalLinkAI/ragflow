...
- 处理耗时(服务端)：281.86304s  脚本耗时：286.5s
- 重解析前快照（无基线结果）：chunk_count=11 run=DONE clinical 类型记录数={'ExaminationReport': 5, 'AdmissionRecord': 1, 'LabReport': 4, 'DischargeRecord': 1}

## 1. 页面覆盖率

| # | chunk_id(前8位) | 页数 | 页码范围 | 内容摘要 |
|---|----------------|------|----------|----------|
| 1 | fcb0fa5e | 3 | 1-3 | 身高169厘米，体重65公斤，没有基础疾病及合并用药，自愿放弃标准治疗 鞍山市肿 |
...
| 10 | 7a0c2235 | 1 | 10-10 | <table><tr><td>癌胚抗原</td><td>None</td><td |
| 11 | 7aaa8577 | 1 | 13-13 | <table><tr><td>谷丙转氨酶</td><td>ALT</td><td |
| 12 | ec44c59a | 1 | 14-14 | <table><tr><td>白细胞计数</td><td>WBC</td><td |
