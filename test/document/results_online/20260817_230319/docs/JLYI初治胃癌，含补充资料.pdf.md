...
- 处理耗时(服务端)：511.48947s  脚本耗时：516.7s
- 重解析前快照（无基线结果）：chunk_count=15 run=DONE clinical 类型记录数={'ExaminationReport': 5, 'AdmissionRecord': 1, 'LabReport': 9}
...
| 15 | 27dfddfe | 1 | 11-11 | <table><tr><td>*钾</td><td>K</td><td>4.60 |
