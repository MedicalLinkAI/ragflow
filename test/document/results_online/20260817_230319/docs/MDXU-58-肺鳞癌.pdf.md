...
- 处理耗时(服务端)：362.31393s  脚本耗时：373.1s
- 重解析前快照（无基线结果）：chunk_count=20 run=DONE clinical 类型记录数={'ExaminationReport': 4, 'AdmissionRecord': 1, 'LabReport': 15}

## 1. 页面覆盖率

| # | chunk_id(前8位) | 页数 | 页码范围 | 内容摘要 |
|---|----------------|------|----------|----------|
| 1 | 974ee5fa | 1 | 1-1 | 姓名： 性别：男 年龄：58岁 婚姻：已婚 入院日期：2026年02月02日 0 |
| 2 | 58033af0 | 1 | 2-2 | 中南大学湘雅二医院 病理体视学检查与图像分析诊断报告 病理号 姓 性别：男 年龄 |
| 3 | 80456e1f | 1 | 3-3 | 中南大学湘雅二医院 THE SECOND XIANGYA HOSPITAL OF |
| 4 | 4be6eb18 | 1 | 4-4 | 中南大学湘雅二医院 心电图报告 患者编> 心室率(60~100):90 bpm  |
| 5 | a3639d33 | 1 | 20-20 | xiangya 中南大学湘雅三医院 The Third Xiangya Hosp |
