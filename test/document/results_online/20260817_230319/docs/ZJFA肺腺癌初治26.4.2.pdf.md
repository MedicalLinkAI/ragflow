...
- 处理耗时(服务端)：474.46927s  脚本耗时：480.2s
- 重解析前快照（无基线结果）：chunk_count=6 run=DONE clinical 类型记录数={'AdmissionRecord': 1, 'LabReport': 2, 'DischargeRecord': 1, 'ExaminationReport': 2}

## 1. 页面覆盖率

| # | chunk_id(前8位) | 页数 | 页码范围 | 内容摘要 |
|---|----------------|------|----------|----------|
| 1 | 7d2477aa | 2 | 1-2 | 姓名： 性别：男 年龄：58岁 住院号： 姓名： 性别：男 年龄：58岁 民族： |
| 2 | 1906886a | 3 | 2-4 | 2026-4-2 聊城市人民医院 出院记录 姓名： 性别：男 年龄：58岁 住院 |
